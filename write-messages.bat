...
@REM call %kafka_dir%\bin\windows\kafka-console-producer.bat --broker-list localhost:9092 --topic messages --property "parse.key=true" --property "key.separator=:" < kafka_users.txt >nul
